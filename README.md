...
This Docker image provides the Ubuntu 16.04 environment with X Windows with Inkscape. It is a demonstration of using x11vnc/desktop for some powerful applications. The X Windows will display in your web browser in full-screen mode. You can use this Docker image on 64-bit Linux, Mac or Windows. It allows you to use the same programming environment regardless which OS you are running on your laptop or desktop.

[![Build Status](https://travis-ci.org/x11vnc/inkscape-desktop.svg?branch=master)](https://travis-ci.org/x11vnc/inkscape-desktop) [![](https://images.microbadger.com/badges/image/x11vnc/inkscape-desktop.svg)](https://microbadger.com/images/x11vnc/inkscape-desktop)
...
To run the Docker image, first download the script [`inkscape_desktop.py`](https://raw.githubusercontent.com/x11vnc/inkscape-desktop/master/inkscape_desktop.py)
...
```
curl https://raw.githubusercontent.com/x11vnc/inkscape-desktop/master/inkscape_desktop.py -outfile inkscape_desktop.py
```
On Linux or Mac, start a terminal, use the `cd` command to change to the working directory, and then run the following command:
```
curl -s -O https://raw.githubusercontent.com/x11vnc/inkscape-desktop/master/inkscape_desktop.py
```

After downloading the script, you can start the Docker image using the command
```
python inkscape_desktop.py -p
```
...
```
python inkscape_desktop.py -v myproject
```
and the work directory will be the data volume.

For additional command-line options, use the command
```
python inkscape_desktop.py -h
```
